...
class DataDrivenRankingSystem:
    ...
    def grade_clusters(self):
        ...
        if 'Wickets' in self.df.columns:  # bowling data
...
if __name__ == "__main__":
    cricket_ranking_system = DataDrivenRankingSystem('/Users/rahuljogi/Desktop/@S4/ML/Project__/Datasets/IPL/pre_processed_data_ipl_bat.csv',2)
    cricket_ranking = cricket_ranking_system.process('/Users/rahuljogi/Desktop/@S4/ML/Project__/Results/IPL/IPL_clustered_BAT.csv',2)
