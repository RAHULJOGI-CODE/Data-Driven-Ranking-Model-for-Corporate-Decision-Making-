...
class DataDrivenRankingSystem:
    ...
    def process(self, output_file):
        self.scaling_data()
        method, score = self.cluster_data(2)
...
#     cricket_ranking_system = DataDrivenRankingSystem('Datasets/IPL/pre_processed_data_ipl_bat.csv',2)
#     cricket_ranking = cricket_ranking_system.process('IPL_clustered.csv')
#     print(cricket_ranking.head(10))